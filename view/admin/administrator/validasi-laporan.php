      ...
      <div class="card">
            <div class="card-body">
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" readonly value="<?php echo $pecah["tgl_pengaduan"] ?>">
                  </div>
              </div>
...
$koneksi->query("UPDATE pengaduan SET status='$status' WHERE id_pengaduan='$id_pengaduan'");
echo "<script> alert('Status Laporan Sudah Edit');</script>";
echo "<script>location='validasi.php';</script>";
}
?>
            </div>
      </div>
